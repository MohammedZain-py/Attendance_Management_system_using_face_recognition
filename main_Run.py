    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Md_zain\PycharD:\Company\Edunet Foundation - Pune\Project\OneDrive_2024-10-01\Attendance Management System using Face Recognition\AttendancemProjects\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/mdzai/P2-Attendance-Management-System-using-Face-Recognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Md_zain\PycharmProjects\Attendace_management_system\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Zain':
            if password == 'Zain123':
                ...
                cs = 'C:/Users/mdzai/P2-Attendance-Management-System-using-Face-Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
