...
```bash
git clone https://github.com/MohammedZain-py/Attendance_Management_system_using_face_recognition.git
...
For any questions or issues, feel free to contact **[md.zain.1293@gmail.com]**.
